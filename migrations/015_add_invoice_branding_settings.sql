...
-- Note: For invoice_header_decoration, ASCII characters work best with PDF generation.
-- Good options: '*** *** ***', '=== === ===', '--- --- ---', '~~~ ~~~ ~~~', '### ### ###'
...
INSERT INTO settings (key, value, data_type, description) VALUES 
    ...
    ('invoice_header_decoration', '*** *** ***', 'string', 'Decorative elements for invoice header (ASCII characters recommended)'),
